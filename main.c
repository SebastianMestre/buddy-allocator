...
void* split_to_fit(struct allocator* allocator, size_t size, size_t idx, int l, int r) {
	size_t n = r - l;
...
void* find_free_and_allocate(struct allocator* allocator, size_t size, size_t idx, int l, int r) {
	if (r - l < size) {
		return NULL;
	}
